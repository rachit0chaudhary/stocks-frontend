      ...
      if (userId) {
        try {
          const response = await axios.get(
            `http://65.0.127.149:5000/api/var/client/trades/chart/${userId}`
          );
...
//             const config = {
//                 method: 'get',
//                 url: `http://65.0.127.149:5000/api/var/client/${userId}`,
//                 headers: {
...
//             const config = {
//                 method: 'get',
//                 url: `http://65.0.127.149:5000/api/var/client/trades/mcx/${userId}`,
//                 headers: {
//                     'Authorization': `Bearer ${token}`
//                 }
//             };
