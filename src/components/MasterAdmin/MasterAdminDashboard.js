...
const MasterAdminDashboard = () => {
    ...
    const fetchMasterAdminData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://65.0.127.149:5000/api/var/masterAdmin/masteradmin/${masterAdminId}`,
          {
            headers: {
    ...
    const fetchClientsData = async () => {
      try {
        ...
        const response = await fetch(
          `http://65.0.127.149:5000/api/var/masterAdmin/clients/${masterAdminId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const updateClientStatus = async (status) => {
    ...
    try {
      const response = await fetch(
        `http://65.0.127.149:5000/api/var/masterAdmin/update-client/${selectedClient._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deleteClient = async () => {
    ...
    try {
      const response = await fetch(
        `http://65.0.127.149:5000/api/var/masterAdmin/delete-client/${selectedClient._id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
