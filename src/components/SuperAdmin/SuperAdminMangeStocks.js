...
const StockTable = () => {
  ...
  const fetchStockData = async () => {
    ...
    try {
      ...
      const config = {
        method: "get",
        url: "http://65.0.127.149:5000/api/var/superAdmin/api/stocks",
        headers: {
  ...
  const fetchBlockedStocks = async () => {
    ...
    try {
      ...
      const config = {
        method: "get",
        url: "http://65.0.127.149:5000/api/var/superAdmin/api/blockStocks",
        headers: {
          Authorization: `Bearer ${token}`,
        },
      };
  ...
  const handleConfirmBlock = async () => {
    ...
    try {
      ...
      const config = {
        method: "post",
        url: "http://65.0.127.149:5000/api/var/superAdmin/api/blockStock",
        headers: {
  ...
  const handleDeleteBlock = async (stock) => {
    try {
      ...
      const config = {
        method: "delete",
        url: `http://65.0.127.149:5000/api/var/superAdmin/api/blockStock/${symbol}`,
        headers: {
          Authorization: `Bearer ${token}`,
        },
      };
